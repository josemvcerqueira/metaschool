 ...
 */
export type RpcTransport = (req: JsonRpcRequest, abortSignal: AbortSignal) => Promise<JsonRpcResponse>;
...
export declare function rpcClient<T extends object>(options: RpcClientOptions): {
    /**
